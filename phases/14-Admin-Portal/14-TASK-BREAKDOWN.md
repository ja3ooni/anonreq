# Phase 14 Task Breakdown: Admin Portal
...
- As an administrator, I can configure Admin Portal for one tenant without affecting another tenant.
...
- Implement services: AdminFrontend, AdminBFF, PermissionAwareNavigation, PolicyEditor, OversightQueueUI, EvidenceExportUI, IncidentWorkbench, GovernanceDashboard.
...
- Add structured audit events: admin_login, admin_action_recorded, human_approval, human_rejection, kill_switch_activated, executive_report_generated.
- Add Prometheus metrics: anonreq_admin_actions_total, anonreq_admin_page_load_seconds, anonreq_oversight_queue_depth, anonreq_kill_switch_state.
