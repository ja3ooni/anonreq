...
func main() {
	...
	payload := map[string]interface{}{
		...
		"messages": []map[string]string{
			{"role": "user", "content": "My tax ID is 12345678901 and phone is +49-30-123456"},
		},
	}
	...
	req.Header.Set("X-AnonReq-Compliance-Preset", "gdpr")
	...
	fmt.Println("PASS: GDPR preset applied")
}
