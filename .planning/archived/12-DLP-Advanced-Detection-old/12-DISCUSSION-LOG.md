# Phase 12 Discussion Log: DLP and Advanced Detection
...
The architecture review approved implementing DLP and Advanced Detection as tenant-scoped gateway services integrated before ForwardingGuard, with metadata-only audit, bounded Prometheus metrics, RBAC-protected administration, OpenAPI-first contracts, and explicit security acceptance gates.
