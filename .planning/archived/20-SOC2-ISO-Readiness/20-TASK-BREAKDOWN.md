# Phase 20 Task Breakdown: SOC2 and ISO Readiness
...
- As an administrator, I can configure SOC2 and ISO Readiness for one tenant without affecting another tenant.
...
- Implement services: ControlCatalog, EvidenceCollector, PolicyDocumentSet, TraceabilityMatrix, RiskRegisterWorkflow, AuditReadinessExporter, VendorQuestionnaireResponder.
...
- Add structured audit events: control_evidence_updated, risk_assessment_approved, governance_review_recorded, audit_package_exported.
- Add Prometheus metrics: anonreq_controls_implemented_total, anonreq_evidence_freshness_seconds, anonreq_risk_treatments_overdue_total.
