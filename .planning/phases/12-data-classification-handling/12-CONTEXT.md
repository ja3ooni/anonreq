...
- **D-017:** Response header X-AnonReq-Classification-Result only when explicitly requested via X-AnonReq-Return-Classification: true header. X-AnonReq-Debug does NOT trigger classification response headers.
