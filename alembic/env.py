"""Alembic environment configuration for AnonReq.

Reads the database URL from ``anonreq.config.settings`` and targets
metadata from ``anonreq.models.audit``. Uses async Alembic with asyncpg
